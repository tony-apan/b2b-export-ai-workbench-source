...
exclude: [".git/**", ".obsidian/**", "node_modules/**", "dist/**", "customer-runtime/**", "credentials/**", "raw/**", "**/client-ids.local.txt", "**/*.py", ".env*", "*.secret", "*.credentials", "*.sqlite*", "*.db", "*.p12", "*.pfx", "*.crt", "*.token", "*.cookie", "*.key", "*.pem", "*.png", "*.jpg", "*.jpeg", "*.webp", "*.gif", "*.mp4", "*.mov", "*.mp3", "*.wav"]
