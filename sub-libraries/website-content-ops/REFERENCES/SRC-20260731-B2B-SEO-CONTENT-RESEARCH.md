---
title: "B2B SEO Content Research Notes"
description: "登记用于 B2B 文章规范的公开研究来源，并把搜索意图、信息增益、客户语言、层级和内链提炼为有边界的执行规则。"
type: "source-note"
source_id: "SRC-20260731-B2B-SEO-CONTENT-RESEARCH"
status: "Working"
owner: "AI"
created: "2026-07-31"
...
| Source | Checked | Used for | Boundary |
|---|---|---|---|
| Google Search Central: helpful content | 2026-07-31 | people-first、first-hand expertise、自我审查 | 官方原则，不提供本站排名保证 |
| Google Search Central: crawlable links | 2026-07-31 | 可抓取链接与描述性 anchor | 技术与写作指导，不证明链接质量 |
| Animalz: Information Gain | 2026-07-31 | 不重复 SERP、增加原始贡献 | 行业方法论，作者也明确算法推断有边界 |
| Ahrefs: How to Format a Blog Post | 2026-07-31 | 首屏直达问题、可扫描层级与强调 | 编辑实践，不应机械变成组件配额 |
| CXL: Voice of Customer | 2026-07-31 | 客户原话、焦虑、异议与下一步 | 个案/方法不能直接外推到所有 B2B 页面 |
| CXL: Three Layers of Customer Pain | 2026-07-31 | surface、friction、strategic consequence | 行业框架，必须由自己的客户证据验证 |

## 提炼规则

1. 写给搜索者完成任务，不写给算法看；搜索意图、受众和结果必须明确。
2. 与现有结果相比，文章应增加原始证据、框架、工具、诊断或具体场景，而不是只增加字数。
3. 客户语言需要从真实记录提取；AI 生成的“像客户会说的话”只能标为 inferred。
4. 标题、首屏、heading 和 semantic emphasis 应形成可扫描的答案路径。
5. 链接文字要描述目标内容；产品、教育和转化页按读者下一步需要出现。
6. 三层痛点帮助把症状连接到操作摩擦和业务后果，但不能借此夸大损失。
7. 所有公开方法都只用于形成写作假设；真实排名和询盘效果必须通过本站数据验证。
