...
sources: ["b2b-seo-article-standard.runtime.md", "b2b-article-optimization-sop.runtime.md", "../10_sources/index.md"]
related: ["index.md", "b2b-seo-article-standard.runtime.md", "b2b-article-optimization-sop.runtime.md", "../TEMPLATES/article-brief.md", "../TEMPLATES/article-draft.md", "../TEMPLATES/article-quality-review.md"]
visibility: "public"
...
本页是 [B2B SEO Article Standard](b2b-seo-article-standard.runtime.md) 的阶段化执行补充，不创建第二套字段、评分或事实规则。AI 在起草文章前必须：
