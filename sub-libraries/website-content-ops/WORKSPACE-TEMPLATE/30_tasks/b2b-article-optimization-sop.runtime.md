...
事实状态、字段 grammar、评分和 fatal gates 以 [B2B SEO Article Standard](b2b-seo-article-standard.runtime.md) 为唯一质量真源。
五阶段的最小正文、产品内链与 CTA 模式见 [B2B Article Stage Patterns](b2b-article-stage-patterns.runtime.md)；它只解释如何消费 Standard，不新增 alias 或第二套门禁。
