...
sources: ["../30_tasks/source-driven-cms-operation-sop.runtime.md"]
...
generated_from: "../../TEMPLATES/content-operation-plan.md"
generated_source_sha256: "f5e222cd45e8dffb4206f94a07c40f74b3a9cf5eda22d8a580b5dd7acbe485bb"
generated_by: "scripts/sync-workspace-template.mjs"
---
<!-- Generated runtime copy from TEMPLATES/content-operation-plan.md; do not hand-edit this copy in the source package. -->
# Content Operation Plan

> 在客户私有运行区复制为 `content-operation-plan.json`。这里不保存客户事实、凭据、Cookie、Action ID、deployment/build ID 或测试站默认值。完整字段以 [Schema](../30_tasks/source-driven-cms-operation-sop.runtime.md) 为准。
