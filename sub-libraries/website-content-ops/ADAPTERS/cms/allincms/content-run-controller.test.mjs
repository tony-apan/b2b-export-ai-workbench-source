...
function makePlan() {
  return reseal({
    ...
    authorization_scope: { status: 'approved', actor: 'Human Reviewer Fixture', identity_status: 'not_verified', target_scope: 'site', target_key: 'site-fixture', operation_ids: ['OP-001', 'OP-002', 'OP-003'], approved_at: '2026-08-12T00:05:00Z', archived_at: '2026-08-12T00:05:00Z', expires_at: '2026-08-12T00:25:00Z', plan_sha256: null },
