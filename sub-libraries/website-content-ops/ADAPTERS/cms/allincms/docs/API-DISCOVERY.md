...
sources: ["SINOPRO 全流程实战（set_home_page/update_page/delete_category 均为逆向发现）", "ISS-070/073/074/076"]
...
```text
### /rry6mpkd7t/themes/6a9308e1.../design
...
### 3.3 实际例子（SINOPRO set_home_page 的发现过程）
