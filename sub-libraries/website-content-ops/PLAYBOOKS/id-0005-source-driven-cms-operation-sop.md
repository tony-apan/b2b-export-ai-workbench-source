...
sources: ["../AGENTS.md", "../INTAKE.md", "../MENTAL-MODEL.md", "../ADAPTERS/README.md", "../RUNTIME-CONTRACT.json"]
related: ["README.md", "../TEMPLATES/content-operation-plan.md", "../SCHEMAS/content-operation-plan.schema.json", "../scripts/validate-content-operation-plan.mjs", "../ADAPTERS/cms/allincms/AI-START-HERE.md"]
visibility: "public"
