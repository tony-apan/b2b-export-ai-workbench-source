...
sources: ["ThermoFlask cs5bpj6pt8 launch audit 2026-08-29", "id-0006-live-allincms-adversarial-review.md", "interface-kit audit scripts"]
related: ["README.md", "../QA-CHECKLIST.md", "id-0002-article-page-frontend-seo-contract.md", "id-0006-live-allincms-adversarial-review.md", "../ADAPTERS/cms/allincms/interface-registry.json"]
visibility: "public"
...
- 命令：`python3 site_pipeline.py audit <slug> --out 70_evidence/audit-report.json`（14 项一体机检）
- 判定：count/200/empty/template/demo-contact/faq-answer/cta/unit/absolute/markdown 全 PASS 为站内判据
- lang/canonical/jsonld/img-attrs 为平台 BLOCK：**不判站内 FAIL，但必须写入交付清单"平台待修复"并保持正式 SEO BLOCK**
...
- **首页/列表页无 og:* 与 canonical**、全站无 JSON-LD、无 favicon/link icon、无 srcset/lazy——平台模板行为（见 C）。

## C. 平台边界（实测 2026-08-29，ThermoFlask cs5bpj6pt8）
...
| C3 | og/canonical/JSON-LD 缺失 | 首页与列表页无 og:*、无 canonical；全站 0 个 JSON-LD；详情页有 og:image（引联资产 URL，200） | 平台模板行为；产品/文章页 og 已由平台按记录注入，站级页面无入口 |
