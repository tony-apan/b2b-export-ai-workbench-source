...
**后续全链交互**（选站确认/进度汇报/阻塞求助/交付验收/收尾提醒）也**照抄模板**，见同文件「〇-b 全链话术（10 张模板，含发布批准/删除授权/凭据失效/跟进）」——不要临场发挥。**对用户说话前先过「〇-a、🗣️ 对用户说话规则」黑话对照表**：用户是三四十岁做外贸的女性中小老板为主，不懂技术，内部术语一律翻译成大白话。
