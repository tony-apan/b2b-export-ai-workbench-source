...
related: ["../30_playbooks/id-0010-geo-ai-search.md", "../50_channels/geo-ai-search/index.md", "../20_concepts/geo-ai-search.md", "../30_playbooks/id-0011-seo-content.md"]
confidence: "medium"
review_after: "2026-09-28"
when_to_read: "核对 GEO、AI 搜索 crawler、实体标记或平台可见性建议前，用本页回到官方资料边界；不据此承诺收录或引用。"
keywords: ["AI search", "Google AI features", "OpenAI crawler", "Bing Webmaster", "schema.org", "GEO 来源"]
---
...
- OpenAI crawlers 需要区分 OAI-SearchBot、GPTBot、ChatGPT-User 等不同角色；OAI-SearchBot 用于搜索结果发现/展示，GPTBot 用于模型训练控制，robots、WAF/CDN 和 server log 都要分开检查。允许 crawler 只提供访问条件，不保证引用或排名。
