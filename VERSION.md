---
title: "Mother Library Version"
description: "私有 canonical 母库源码的当前工作版本、同步状态和兼容性入口；它不代表公开或稳定发布。"
type: "version"
status: "Working"
owner: "AI"
created: "2026-07-28"
...
- Released：Private source sync candidate（2026-07-30）
- Compatibility：普通 Git checkout、Markdown 阅读器和可读取本地文件的 AI agent；不要求 Obsidian。
- Repository sync status：`Ready`
